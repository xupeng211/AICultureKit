...
953. ⚠️ [culture] **tools/problem_aggregator/adapters/lint.py:172** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

954. ⚠️ [culture] **tools/problem_aggregator/adapters/lint.py:174** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

955. ⚠️ [culture] **tools/problem_aggregator/adapters/security.py:265** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

956. ⚠️ [culture] **tools/problem_aggregator/adapters/security.py:267** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

957. ⚠️ [culture] **tools/problem_aggregator/adapters/security.py:269** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

958. ⚠️ [culture] **tools/problem_aggregator/adapters/security.py:271** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

959. ⚠️ [culture] **tools/problem_aggregator/adapters/security.py:276** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

960. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:349** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

961. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:351** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

962. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:353** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

963. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:355** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

964. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:357** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

965. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:359** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

966. ⚠️ [culture] **tools/problem_aggregator/adapters/tests.py:364** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

967. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:78** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

968. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:102** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

969. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:106** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

970. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:117** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

971. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:123** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

972. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:129** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

973. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:133** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

974. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:135** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

975. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:138** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

976. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:146** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

977. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:148** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

978. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:151** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

979. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:164** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

980. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:166** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

981. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:169** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

982. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:183** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

983. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:185** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

984. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:187** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

985. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:190** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

986. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:194** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

987. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:196** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

988. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:207** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

989. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:235** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

990. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:237** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

991. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:411** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

992. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:422** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

993. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:426** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

994. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:427** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

995. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:428** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

996. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:429** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

997. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:430** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

998. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:431** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

999. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:437** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging

1000. ⚠️ [culture] **tools/problem_aggregator/aggregator.py:440** 发现调试print语句
   💡 **修复建议**: 移除print语句或使用logging
...
2. ❌ 🚫 [diff-cover]  无法生成覆盖率报告
   💡 **修复建议**: 确保安装了pytest-cov并且测试可以运行
...
1. **N/A:0** - 测试收集失败: 
   💡 检查测试文件语法和导入
2. **N/A:0** - 无法生成覆盖率报告
   💡 确保安装了pytest-cov并且测试可以运行

### 📈 按工具统计

- **pytest**: 1 个问题 (1 个阻塞)
- **coverage**: 1 个问题 (0 个阻塞)
- **diff-cover**: 1 个问题 (1 个阻塞)
- **culture**: 1000 个问题 (0 个阻塞)
...
- **tools/problem_aggregator/aggregator.py**: 34 个问题

## 🚀 建议的下一步行动

1. **立即修复阻塞性问题** - 这些问题会阻止代码提交
2. **修复 2 个错误** - 这些是严重问题
3. **处理 1001 个警告** - 提升代码质量
