...
class AICultureKitIDE:
    ...
    def run_full_workflow(self, base: str = "origin/main", auto_apply: bool = False) -> Dict[str, Any]:
        """运行完整的一键工作流"""
    ...
    def _run_problem_aggregator(self, base: str) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                ...
                "--base", base,
                "--out", str(self.artifacts_dir / "ide_problems.json"),
                "--md", str(self.artifacts_dir / "ide_problems_report.md")
            ]
    ...
    def _run_ai_fix_agent(self) -> Dict[str, Any]:
        ...
        try:
            ...
            cmd = [
                ...
                "--in", str(problems_file),
                "--out", str(self.artifacts_dir / "ide_ai_fixes")
            ]
    ...
    def _verify_fixes(self, base: str) -> Dict[str, Any]:
        ...
        try:
            cmd = [
                "python", "-m", "tools.problem_aggregator.aggregator",
                "--base", base,
                "--out", str(self.artifacts_dir / "ide_post_fix_problems.json"),
                "--md", str(self.artifacts_dir / "ide_post_fix_report.md")
            ]
    ...
    def _generate_workflow_summary(self, workflow_result: Dict[str, Any]) -> None:
        ...
        lines.append(f"- **修复率**: {(fixed/before*100):.1f}%" if before > 0 else "- **修复率**: N/A")
        lines.append("")
