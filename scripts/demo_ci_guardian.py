...
'''
    ...
    def analyze_issues(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                [
                    "python", "scripts/ci_issue_analyzer.py",
                    "-l", "logs/demo_ci_output.json",
                    "-s", "-r"
                ],
                capture_output=True,
                text=True,
    ...
    def generate_defenses(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                [
                    "python", "scripts/defense_generator.py",
                    "-i", "logs/ci_issues.json",
                    "-s"
                ],
                capture_output=True,
                text=True,
    ...
    def integrate_defenses(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                [
                    "python", "scripts/auto_ci_updater.py",
                    "-d", "logs/defenses_generated.json"
                ],
                capture_output=True,
                text=True,
                cwd=self.project_root,
    ...
    def validate_defenses(self) -> bool:
        ...
        try:
            ...
            result = subprocess.run(
                [
                    "python", "scripts/defense_validator.py",
                    "-d", "logs/defenses_generated.json",
                    "-i", "logs/ci_issues.json",
                    "-s"
                ],
    ...
    def show_demo_summary(self) -> None:
        ...
        for log_file in ["ci_issues.json", "defenses_generated.json", "validation_results.json"]:
